...
container.addEventListener("click",(e)=> {
    ...
    if(e.target.tagName === "I"){
        e.preventDefault();    
        e.stopPropagation();
        // let originalValue = e.target.nextElementSibling.textContent;   
        let editedvalue = prompt("re-write or edit your task");

        //agar user ne cancel kara (prompt.value = null) or kuch bhi nahi likha to task edit nahi hoga;
